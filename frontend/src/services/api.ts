...
export const api = {
  ...
  analyzeDocument: (id: string, model = 'logistic_regression') => request<AnalysisResponse>(`/api/documents/${id}/analyze`, { method: 'POST', body: JSON.stringify({ model }), headers: { 'Content-Type': 'application/json' } }),
